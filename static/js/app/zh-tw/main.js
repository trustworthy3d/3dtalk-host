$(function() {
        ...
        function gcode_upload_fail(e, data) {
            $.pnotify({
                title: "上傳失敗",
                text: "<p>不能上傳這個檔。請確認它是一個帶有\".gcode\"、\".gco\"或\".g\"尾碼擴展名的GCODE檔，或者您是在您的Cura切片軟體被配置且開啟的前提下，上傳的一個帶有\".stl\"尾碼擴展名的STL檔。</p><p>伺服器的報告是: <pre>" + data.jqXHR.responseText + "</pre></p>",
                type: "error",
                hide: false
            });
            $("#gcode_upload_progress .bar").css("width", "0%");
        ...
        function gcode_upload_progress(e, data) {
            ...
            $("#gcode_upload_progress .bar").text("正在上傳 ...");
            if (progress >= 100) {
